        ...
        render(){
            ...
            return(
                <OuterContainer header={location.state && location.state.header}>
                    ...
                    <DatePicker className='date-picker w-100' disableFuture openTo="year" format="LLL" label="Date of birth" views={["year", "month", "date"]} value={formData.dob} onChange={(e)=>this.handleStateChange('dob', moment(e))} />
